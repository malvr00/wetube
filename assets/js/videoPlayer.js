...
//현제 재생 표시
function getCurrentTime(){ // 현재 재생 시점을 초 단위로 표현한 double값입니다. 이 값을 세팅하여 재생 시점을 변경할 수 있습니다.
    currentTime.innerText = formatDate(videoPlayer.currentTime)
    // 한번말 발생함.
}

//전체 동영상 길이
function setTotalTime(){// 미디어의 전체 길이를 초 단위로 double 값으로 반환합니다. 재생 가능한 미디어가 없을 경우 0을 반환합니다.
